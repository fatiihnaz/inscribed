...
export const collections = Object.freeze({
  ...
  "collections.searchEmpty": "No records match \"{query}\".",
  "collections.searchApproximate": "No exact matches; showing similar records.",
  ...
  "collections.translationMissing": "This record has no {locale} version yet. Saving creates it and links it to this one.",
  "collections.translationAbsent": "This record has no {locale} version.",
  "collections.translationCopied": "{fields} will be copied from this record.",
  "collections.openTranslation": "Open the {locale} record",
  "collections.localeFailed": "{locale} could not be published: {reason}",
