...
function RegionSection({ collectionKey, filter, pageLimit, pageOffset, showHeader }) {
  ...
  useEffect(() => {
    ...
    // Drop only the slug-less new-item sentinel (AutoGenerated's create
    // draft, surfaced through CreateForm). A boot-GUID row that *does*
    // carry a slug is a RoleDerived virtual item — the user's own
    // editable row that gets created via PUT on first save — so it stays
    // in the list and renders as a normal card.
